...
import 'package:dahab_clinic_management/screen/no_data_screen.dart';
...
class _ServiceScreenState extends State<ServiceScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:Obx(() {
        if(serviceDeController.resultModel.value is ServiceDetailsResponseModel){
          return  Stack(
            children: [
              Container(
                ...
                decoration:  BoxDecoration(
                  image: DecorationImage(
                      image: NetworkImage("http://127.0.0.1:8000${(serviceDeController.resultModel.value as ServiceDetailsResponseModel).image}",
                      ), fit: BoxFit.fill),
                ),
                child: ClipRRect(
                  child: Container(
              ...
              Positioned(
                ...
                left: 150,
                child: Text(
                  (serviceDeController.resultModel.value as ServiceDetailsResponseModel).name,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "\$${(serviceDeController.resultModel.value as ServiceDetailsResponseModel).price
                      }",
                    ...
                    Text(
                      (serviceDeController.resultModel.value as ServiceDetailsResponseModel).description,
                      style: const TextStyle(
                        fontSize: 16.0,
                      ),
          ...
          {
            return NoDataScreen();
          } else if(serviceDeController.resultModel.value is ErrorsResult)
            {
